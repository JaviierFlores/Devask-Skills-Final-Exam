...
if choice == "N" or choice == "n":
  ...
  accessToken = "Bearer " + accessToken
    ...
    accessToken = "Bearer YWEwYTVkOTktOGU3My00MDY0LTljYjYtMDQwOWI3Njk4ODU1ZDVkZmUwNDEtNWEx_P0A1_d5fe8096-9b9a-43dd-bc72-9f86104a819b"
...
# 6. Provide your MapQuest API consumer key.
        ...
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "Q4YxMKFzG9N6FIgm4yYqF6QOV0JaG0Af"
                               }
# 7. Provide the URL to the MapQuest address API.
